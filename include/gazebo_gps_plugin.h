...
//  double alt_home = 488.0;                     // meters
  ...
  // Port-aux-Francais (-55 deg declination): -49.350330,  70.219162
//  double lat_home = -49.350330 * M_PI / 180;  // rad
//  double lon_home = 70.219162 * M_PI / 180;  // rad
//  double alt_home = 10.0;                    // meters
